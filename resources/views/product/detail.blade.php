            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="zoomWrapper">
                    <div id="img-1" class="zoomWrapper single-zoom">
                        <a href="#">
                            <div class="zoomWrapper"><img style="width: 320px; height: 320px"
                                    src="{{ asset(pare_url_file($productDetail->pro_avatar)) }}"></div>
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="actions-e">
                                <div class="action-buttons-single">
                                    ...
                                    <div class="add-to-cart">
                                        <a href="{{ route('add.shopping.cart',$productDetail->id)}}">Thêm vào giỏ
                                            hàng</a>
                                    </div>
            ...
            <div class="single-product-tab">
                ...
                <div class="tab-content">
                    ...
                    <div class="components_rating" style="margin-bottom: 20px">
                        ...
                        <div class="components_rating_content"
                            style="display: flex;align-items: center;border: 1px solid #dedede;border-radius: 5px">
                            <div class="rating_item" style="width: 20%;position: relative">
                                <span class="fa fa-star"
                                    style="font-size: 100px;display: block;color: #ff9750;margin: 0 auto;text-align: center"></span><b
                                ...
                                <div class="item_rating" style="display: flex;align-items: center">
                                    ...
                                    <div style="width: 70%;margin: 0 20px">
                                        <span
                                            ...
                                            <b
                                                style="width: {{ $itemAge }}%;background-color: #f25800;display: block;border-radius: 5px;height: 100%"></b>
                                        </span>
                                    </div>
                                    <div style="width: 20%">
...
?>
                    ...
                    <div class="component_list_rating">
                        ...
                        <div class="rating_item" style="margin: 10px">
                            <div>
                                <span
                                    style="color: #333;font-weight: bold;text-transform: capitalize">{{ isset($rating->user->name) ? $rating->user->name : "[N\A]"}}
                                </span>
                                <a href="" style="color: #2ba832"> <i class="fa fa-check-circle-o"></i> Đã mua hàng tại
                                    website</a>
                            </div>
                            <p style="margin-bottom: 0">
                                <span class="pro-rating">
                                    @for($i = 1; $i <= 5;$i ++) <i
                                        class="fa fa-star {{ $i<= $rating->ra_number ? 'active' : ''}}"></i>
                                        @endfor
                                </span>
