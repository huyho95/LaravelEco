<header class="short-stor">
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="mainmenu">
                    <nav>
                        <ul>
                                ...
                                <ul class="restrain sub-menu">
                                    ...
                                    <li>
                                        ...
                                        <a style="font-size: 15px"
                                            href="{{ route('get.list.product',[$cate->c_slug,$cate->id]) }}"><i
                                                class="{{ $cate-> c_icon }}"></i> {{ $cate-> c_name }}</a>
                                    </li>
                                    @endforeach
                                    @endif
                                </ul> -->
                            ...
                            <li class="expand"><a style="padding-right: 10px" href="{{ route('get.list.article') }}"
                                    title="Tin tức">TECH-NEWS</a>
                            </li>
                            <li class="expand"><a style="padding-right: 10px" href="{{ route('get.intro') }}">About</a>
                            </li>
                            <li class="expand"><a style="padding-right: 10px"
                                    href="{{ route('get.contact') }}">Contact</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- mobile menu start -->
            ...
            <div class="col-md-3 col-sm-12 nopadding-left" style="padding-left: 30px;">
                                ...
                                <div class="container nopadding-right">
                                    <form action="{{ route('get.product.list') }}" id="searchform" method="get">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="k" maxlength="128"
                        ...
                        <div class="expand dropps-menu">
                            ...
                            <ul class="restrain language" style="width: 200px;text-align: left">
                                ...
                                <li><a href="{{ route('user.dashboard') }}"
                                        title="Quản lý tổng quan">{{ get_data_user('web','name') }}</a></li>
