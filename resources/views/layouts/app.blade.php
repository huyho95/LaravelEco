...
<body class="home-one">
    ...
    <div class="alert alert-warning alert-dismissible"
        style="position: fixed;right: 20px;top: 20px;left: 50%;transform: translateX(-50%);z-index: 9999999999999">
    ...
    (function() {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/5e418906a89cda5a18852abe/default';
        s1.charset = 'UTF-8';
