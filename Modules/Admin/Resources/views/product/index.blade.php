...
<div class="table-responsive">
    <h2>Quản lý sản phẩm <a href="{{ route('admin.get.create.product') }}" class='pull-right'><i
                class="fas fa-plus-circle" style="font-size: 25px"></i></a></h2>
            ...
            <tr>
                ...
                <td>
                    ...
                    <ul style='padding-left: 15px'>
                        <li><span style="..."><i class="fas fa-dollar-sign" style="..."></i><span></span>
                                {{ number_format($product->pro_price,0, ',', '.') }} (đ)</span></li>
                        <li><span style="..."><i class="fas fa-dollar-sign" style="..."></i><span></span>
                                {{ $product->pro_sale }} (%)</span></li>
                        <li><span>Đánh giá :</span>
                            <span class="rating">
                                @for($i = 1; $i <= 5; $i ++) <i class="fa fa-star {{ $i <= $age ? 'active' : ''}}"
                                    style="color: #999"></i>
                                    @endfor
                            </span>
                            <span>
                ...
                <td>
                    <img src="{{ asset(pare_url_file($product->pro_avatar)) }}" alt="" class='img img-responsive'
                ...
                <td>
                    <a class="btn_customer_action"
                        style="border: 1px solid #999;padding: 5px 6px;border-radius: 5px;font-weight: bold;font-size: 12px;"
                        href="{{ route('admin.get.edit.product',$product->id) }}"><i class="fas fa-pen"
                            style="font-size: 11px"></i> Cập nhật</a>
                    <a class="btn_customer_action"
                        style="border: 1px solid #999;padding: 5px 6px;border-radius: 5px;font-weight: bold;font-size: 12px;"
                        href="{{ route('admin.get.action.product',['delete',$product->id]) }}"><i
                            class="fas fa-trash-alt" style="font-size: 11px"></i> Xóa</a>
                </td>
            </tr>
            @endforeach
            @endif
